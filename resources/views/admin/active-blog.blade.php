					...
					<div class="row">
						<div class="col-md-9">
							<ul class="list-links mb-4">
								<li class="active"><a href="{{url('admin/active-blog')}}">Active Blog</a></li>
								<li><a href="{{url('admin/pending-blog')}}">Pending Blog</a></li>
							</ul>
						</div>
							...
							<div class="blog grid-blog flex-fill">
								...
								<div class="row">
									...
									<div class="col text-end">
										<a href="javascript:void(0);" class="text-danger"><i class="feather-eye-off me-1"></i> Inactive</a>
									</div>
								</div>
							</div>										
						</div>
