						...
						<div class="col-sm-12">
							...
							<div class="card">
								<div class="card-header">
									...
									<p class="card-text">For custom Bootstrap form validation messages, you’ll need to add the <code>novalidate</code> boolean attribute to your form. For server side validation <a href="{{url('https://getbootstrap.com/docs/5.0/forms/validation/')}}" target="_blank">read full documentation</a>.</p>
								</div>
								<div class="card-body">
									<div class="row">
										<div class="col-sm">
