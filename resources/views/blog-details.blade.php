							...
							<div class="blog-view">
								<div class="blog blog-single-post">
									<div class="blog-image">
										<a href="javascript:void(0);"><img alt="" src="{{ URL::asset('/assets/img/blog/blog11.png')}}" class="img-fluid"></a>
									</div>
									...
									<div class="about-author">
										<div class="about-author-img">
											<div class="author-img-wrap">
												<a href="{{url('doctor-profile')}}"><img class="img-fluid rounded-circle" alt="" src="{{ URL::asset('/assets/img/doctors/doctor-thumb-02.jpg')}}"></a>
											</div>
										</div>
								...
								<div class="card blog-comments clearfix">
									...
									<ul class="comments-list">
										<li>
											<div class="comment">
												<div class="comment-author">
													<img class="avatar" alt="" src="{{ URL::asset('/assets/img/patients/patient4.jpg')}}">
												</div>
											...
											<ul class="comments-list reply">
												<li>
													<div class="comment">
														<div class="comment-author">
															...
															<img class="avatar" alt="" src="{{ URL::asset('/assets/img/patients/patient5.jpg')}}">
												...
												<li>
													<div class="comment">
														<div class="comment-author">
															<img class="avatar" alt="" src="{{ URL::asset('/assets/img/patients/patient3.jpg')}}">
														</div>
														<div class="comment-block">
															<span class="comment-by">
										...
										<li>
											<div class="comment">
												<div class="comment-author">
													<img class="avatar" alt="" src="{{ URL::asset('/assets/img/patients/patient6.jpg')}}">
												</div>
												<div class="comment-block">
													<span class="comment-by">
										...
										<li>
											<div class="comment">
												<div class="comment-author">
													<img class="avatar" alt="" src="{{ URL::asset('/assets/img/patients/patient7.jpg')}}">
												</div>
												<div class="comment-block">
													<span class="comment-by">
