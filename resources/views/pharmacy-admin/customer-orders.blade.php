...
@component('pharmacy-admin/components.page-header')                
    @slot('title') Customer Order @endslot
@endcomponent
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="#">
																<img class="avatar avatar-img" src="{{ URL::asset('/assets_pharmacy/img/products/product3.jpg')}}" alt="User Image">Adderall
															</a>
														</h2>
													</td>
													<td>Aripiprazole</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="#">
																<img class="avatar avatar-img" src="{{ URL::asset('/assets_pharmacy/img/products/product4.jpg')}}" alt="User Image">Adderall
															</a>
														</h2>
													</td>
													<td>Phytopathology</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="#">
																<img class="avatar avatar-img" src="{{ URL::asset('/assets_pharmacy/img/products/product6.jpg')}}" alt="User Image">Actamin
															</a>
														</h2>
													</td>
													<td>Aripiprazole</td>
