...
@component('components.breadcrumb')
	@slot('title') Pharmacy In United States @endslot                
@endcomponent
										...
										<div class="doc-info-left">
											<div class="doctor-img1">
												<a href="{{url('pharmacy-details')}}">
													<img src="{{ URL::asset('/assets/img/medical-img1.jpg')}}" class="img-fluid" alt="User Image">
												</a>
											</div>
								...
								<div class="card-body">
									<div class="doctor-widget">
										<div class="doc-info-left">
											<div class="doctor-img1">
												<a href="{{url('pharmacy-details')}}">
													<img src="{{ URL::asset('/assets/img/medical-img2.jpg')}}" class="img-fluid" alt="User Image">
												</a>
											</div>
											<div class="doc-info-cont">
												<h4 class="doc-name mb-2"><a href="{{url('pharmacy-details')}}">PharmaMed Medical</a></h4>
												<div class="rating mb-2">
													<span class="badge badge-primary">4.0</span>
													<i class="fas fa-star filled"></i>
													<i class="fas fa-star filled"></i>
								...
								<div class="card-body">
									<div class="doctor-widget">
										<div class="doc-info-left">
											<div class="doctor-img1">
												<a href="{{url('pharmacy-details')}}">
													<img src="{{ URL::asset('/assets/img/medical-img3.jpg')}}" class="img-fluid" alt="User Image">
												</a>
											</div>
											<div class="doc-info-cont">
												<h4 class="doc-name mb-2"><a href="{{url('pharmacy-details')}}">The Pill Club Medical</a></h4>
												<div class="rating mb-2">
													<span class="badge badge-primary">4.0</span>
													<i class="fas fa-star filled"></i>
													<i class="fas fa-star filled"></i>
