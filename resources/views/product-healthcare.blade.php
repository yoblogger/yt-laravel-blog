...
@component('components.breadcrumb')                
    @slot('title') Health Products @endslot
    @slot('li_1') Home @endslot
    @slot('li_2') Health Product @endslot
@endcomponent
								...
								<div class="col-md-12 col-lg-4 col-xl-4 product-custom">
                             	...
                             	<div class="col-md-12 col-lg-4 col-xl-4 product-custom">
	                                <div class="profile-widget">
										<div class="doc-img">
											<a href="{{url('product-description')}}" tabindex="-1">
												<img class="img-fluid" alt="Product image" src="{{ URL::asset('/assets/img/products/product9.jpg')}}">
											</a>
											<a href="javascript:void(0)" class="fav-btn" tabindex="-1">
												<i class="far fa-bookmark"></i>
											</a>
